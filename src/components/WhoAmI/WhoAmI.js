...
const WhoAmI = () => {
    return (
        <div class="container mt-5 text-center">
            ...
            <hr />
            <p className="text-secondary">Hi. I'm Satya Ranjan, a react-based front-end developer with experience creating successful <span className="text-warning font-weight-bold">responsive websites</span> using <span className="text-success font-weight-bold">MERN</span> technology by implementing <span className="text-danger font-weight-bold">CRUD</span> architectural style, that are fast, easy to use.</p>
