    ...
    return (
        <div class="container my-5">         
            ...
            <div className="row d-inline">
                ...
                <p className="text-size mb-5">I am Front-end Developer with experience in developing commercial websites using MERN Technologies. I have completed my graduation in Mathematics and grew strong interest in developing websites, which motivated me to join the "Web-development courses" offered by Programming Hero. </p>
