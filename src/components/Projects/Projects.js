                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="https://github.com/KKGHOSE2021/coronaV-medical-supplies-client" target="_blank" class="btn btn-primary d-flex justify-content-center rounded-pill">Client site</a>
                            <a href="https://github.com/KKGHOSE2021/coronaV-medical-supplies-server" target="_blank" class="btn btn-primary d-flex justify-content-center ml-3 rounded-pill">Server site</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div className="d-flex">
                            <a href="https://github.com/KKGHOSE2021/phone-shop-client" target="_blank" class="btn btn-primary d-flex justify-content-center rounded-pill">Client site</a>
                            <a href="https://github.com/KKGHOSE2021/phone-shop-server" target="_blank" class="btn btn-primary d-flex justify-content-center ml-3 rounded-pill">Server site</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div className="d-flex">
                            <a href="https://github.com/KKGHOSE2021/dhaka-metro-rail" target="_blank" class="btn btn-primary d-flex justify-content-center rounded-pill">Client site</a>
                            <a href="https://github.com/KKGHOSE2021/dhaka-metro-rail" target="_blank" class="btn btn-primary d-flex justify-content-center ml-3 rounded-pill">Server site</a>
                            </div>
                        </div>
                    </div>
                </div>
